...
public class Level3Logic : LevelLogic
{
    ...
    private async Awaitable StartOfLevel()
    {
        ...
        // Message 5
        hypoTalkBox.TriggerAnimation(audioClips[5], "Nu gaat de meneer in de video je precies vertellen welke symptomen er kunnen zijn en wat ze betekenen. Druk maar op de play knop als je er klaar voor bent!");
